...
public class EditSellerProfileServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (user != null) {
            ...
            RequestDispatcher requestDispatcher = req.getRequestDispatcher("editSellerProfile.jsp");
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (!errorList.isEmpty()) {
            ...
            try {
                ...
                RequestDispatcher requestDispatcher = req.getRequestDispatcher("seller.jsp");
                requestDispatcher.forward(req, resp);
